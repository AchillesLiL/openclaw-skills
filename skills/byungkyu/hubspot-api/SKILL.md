...
```
https://gateway.maton.ai/hubspot/{endpoint}
```

The gateway proxies requests to `api.hubapi.com` and automatically injects your OAuth token.
...
If you have multiple HubSpot accounts connected, specify which to use:
